...
Cell line used in this study: `r params$celltype`
</span>

This report shows the results of the TGx-DDI biomarker analysis for the `r params$platform` platform. 
TGx-DDI was developed as a toxicogenomics signature for DNA damage-induction in human cells in culture ([@li2019review], https://cebs.niehs.nih.gov/tgxddi/).
