...
pass_table %>%
  ...
  footnote(footnote_as_chunk = TRUE,
           general = "Technical controls and reference RNA are used to check the quality of the sequencing run and to compare between batches. They are not subject to QC filters.")
```
