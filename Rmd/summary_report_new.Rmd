...
Quality control of each sample is performed according to the criteria laid out in @harrill2021high, plus an additional filter for the distance between samples in hierarchical clustering.
...
## Samples passing quality control
...
num_passed_total <- num_passed_samples + num_passed_solvent + num_passed_refs
