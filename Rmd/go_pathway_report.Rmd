...
id_table_entrez <- params$biospyder %>%
  dplyr::select(!!sym(params$feature_id), Gene_Symbol, Entrez_ID)



probeIDDEGs <- data.frame(genes=significantResults[[params$feature_id]])
names(probeIDDEGs)[names(probeIDDEGs) == 'genes'] <- params$feature_id
