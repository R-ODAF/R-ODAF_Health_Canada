...
params:
  ...
  group_facet: "chemical_timepoint"       #null # If you have many different experimental groups, you may subset the report by specifying a column in the metadata to filter groups, and then setting the group of interest in group_filter
  group_filter:  "BitB_24h"       # null # Which group will this report be done on?
