...
tk6 <- readRDS("bootstrap_DEGs/output/1000_iterations/nobatch_2023-05-10/tk6.RDS")
spheroids <- readRDS("bootstrap_DEGs/output/1000_iterations/nobatch_2023-05-10/spheroids.RDS")
mcf7 <- readRDS("bootstrap_DEGs/output/1000_iterations/nobatch_2023-05-10/mcf7.RDS")
heparg <- readRDS("bootstrap_DEGs/output/1000_iterations/nobatch_2023-05-10/heparg.RDS")
...
ggplot(data = all_cell_lines %>% dplyr::filter(!Filter=="n_raw_DEGs"),
       aes(x=n_per_group, y=y))+
  geom_bar(stat="identity",
           position = "stack",
           aes(fill=factor(range,
