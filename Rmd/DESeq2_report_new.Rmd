...
if(params$platform == "TempO-Seq"){
  ...
  id_table <- AnnotationDbi::select(db,
                                    ...
                                    keys = allResults$Ensembl_Gene_ID, keytype="ENSEMBL") %>% distinct()
...
```{r volcano_by_contrast, fig.width = 10, fig.height = 6, warning = TRUE, collapse = TRUE}
...
# Useful links...
# https://stackoverflow.com/questions/45756446/interactively-change-color-of-points-in-traces-in-r-plotly
# https://stackoverflow.com/questions/68471610/r-plotly-dropdown-variable-selection-with-color
# https://plotly.com/r/dropdowns/
# https://stackoverflow.com/questions/63940025/menu-or-buttons-to-select-by-which-variable-style-the-plot-in-r-plotly
# https://stackoverflow.com/questions/51261228/interactively-select-a-grouping-variable-in-plotly
# https://plotly.com/r/custom-buttons/#update-button
# https://plotly-r.com/client-side-linking.html
# https://meghansaha.github.io/NYS_MH_Programs/
...
plot_DEG_heatmap <- function(rld_data){
  ...
  mutate(label = paste0(Gene_Symbol," : ",Feature_ID)) %>%
...
plotCounts_gg <- function(i, d, intgroup) {
    ...
    plot_title <- paste(id_table[["Gene_Symbol"]][grep(i,id_table[["Feature_ID"]])],
                        ...
                        id_table[["Feature_ID"]][grep(i, id_table[["Feature_ID"]])])
    if (ncol(plotdata) > 2) {
      colorCol = 3
    } else {colorCol = 2}
