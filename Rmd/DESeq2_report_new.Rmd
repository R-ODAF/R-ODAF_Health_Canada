...
volcano_df[!is.na(volcano_df[['padj']]) &
             ...
             volcano_df['Feature_ID'] %in% volcano_df_sig['Feature_ID'],
...
if(params$platform == "TempO-Seq"){
  ...
  id_table <- AnnotationDbi::select(get(params$species_data$orgdb), columns = c("ENSEMBL", "SYMBOL"), keys = allResults$Ensembl_Gene_ID, keytype="ENSEMBL")
