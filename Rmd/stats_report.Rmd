...
params:
  ...
  group_facet: "chemical_timepoint"       # If you have many different experimental groups, you may subset the report by specifying a column in the metadata to filter groups, and then setting the group of interest in group_filter
...
# table of sample metadata
removed <- DESeqDesign %>% dplyr::filter(!original_names %in% DESeqDesign_subset$original_names)
...
## Standard Deviation vs  {.tabset .tabset-fade}
