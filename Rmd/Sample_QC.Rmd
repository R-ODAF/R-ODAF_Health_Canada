...
params:
  ...
  project_name: "2021_Chauhan_lymphocyte_radiation"        # Change depending on your project name
  clust_method: "spearman" # For clustering
  tree_height_cutoff: 0.5  # For clustering
  ...
  align_threshold: 0.3     # 50% alignment rate for TempO-Seq Experiments
  gini_cutoff: 0.95
