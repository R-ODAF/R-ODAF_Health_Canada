...
(plate_plot +
  ...
  layout(autosize = F, width = 500, height = 333)
...
```{r plot_batch_effects, eval = !is.na(batch_var), fig.height = as.numeric(custom_fig_height)}
...
```{r plot_chemical_differences, eval=!is.na(params$dose), fig.height = as.numeric(custom_fig_height)}
