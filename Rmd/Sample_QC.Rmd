...
A PCA plot will go here once I figure out how to do it.
It should include all samples EXCEPT those removed manually...right?


```{r pca_plot, fig.width = 11, fig.height = 10, echo=FALSE}
...
# Plot PCA
p_pca <- ggplot(pca_data, aes(x = PC1, y = PC2, color = chemical, shape = dose_level)) +
  geom_point(size = 3) +
...
```{r group-correlation-setup, results='asis', echo=FALSE}
# I really need to move this higher so I can plot samples failing these dendros in the tables
# But how to do that higher up, but have the dendros appear down here in the report?
