...
params:
  ...
  biospyder_dbs:  "/home/mmeier/shared/dbs/biospyder/unify_temposeq_manifests/output_manifests"
  biospyder_manifest_file:  "Human_Whole_Transcriptome_2.0_standardized.csv"
...
if (params$collapse_replicates == T) {
  ...
  count_data <- read.table(count_data_file,
                           ...
                           row.names = 1,
                           check.names = FALSE)
  multiQCFile <- file.path(paths$qc, "multiqc_data.zip")
...
############################################################################
flag_order <- order(as.matrix(d[treatment_var]))
d <- d[flag_order,]
count_data <- count_data[,d$original_names]
############################################################################
