...
plot(as.dendrogram(clustered_DEGs_0.01_scaled), horiz = F)
...
Same plot as above, just without the title and with larger font
```{r}
par(mar = c(8,4,4,4), cex = 1)
plot(dend.top.active_0.1, horiz = F)
...
```{r}
par(mar = c(6.5,4,4,4), cex = 1)
plot(hca_biomarker_genes_dendro, horiz = F)
...
```{r}
par(mar = c(8,4,4,4), cex = 1)
plot(hca_biomarker_genes_topactive_dendro, horiz = F)
