...
make_heatmap <- function (filtered_data, threshold_lo, threshold_hi, colours, breaks = NULL) {
  ...
  colnames(data_matrix) <- filtered_data$Compounds
...
table_data <- data.frame(
  ...
  Reference = c("@corton_gene_2022", "", "",
                "@rooney_activation_2018", "@thienpont_novel_2023", "@corton_50_gene_2024",
                "@ryan_moving_2016", "@lichtenstein_transcript_2020", "@jonsson_hypoxia-independent_2016",
