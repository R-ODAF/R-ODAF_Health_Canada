...
make_heatmap <- function (filtered_data, threshold_lo, threshold_hi, colours) {
  ...
  if (threshold_hi == 4) {
    ...
    legend_text <- seq(min(data_matrix[-1], na.rm = TRUE), max(data_matrix[-1], na.rm = TRUE), length.out = 21) %>% round()
...
continuous_colors <- colorRampPalette(c("blue", "white", "red"))(21)
